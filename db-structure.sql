...
# Database: c1_ymag
# Generation Time: 2018-01-25 11:20:56 +0000
# ************************************************************
...
CREATE TABLE `custom_events` (
  ...
  `time_option` int(11) NOT NULL,
  `time` datetime NOT NULL,
  `autoGenerated` tinyint(4) NOT NULL,
...
CREATE TABLE `news_feeds` (
  ...
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `news_feeds_name_index` (`name`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
CREATE TABLE `quotes` (
  ...
  `show_at` date DEFAULT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `quotes_quote_unique` (`quote`),
  KEY `quotes_language_index` (`language`),
  KEY `quotes_show_at_index` (`show_at`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
CREATE TABLE `users` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `google_id` varchar(30) COLLATE utf8_unicode_ci NOT NULL,
  `language` varchar(2) COLLATE utf8_unicode_ci NOT NULL DEFAULT 'en',
  `theme` varchar(20) COLLATE utf8_unicode_ci DEFAULT NULL,
