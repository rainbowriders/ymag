...
<div class="wrapper-page" style="width: 80%">
    ...
    <div class="m-t-40 card-box">
        <div class="text-center">
            <h3 class="text-uppercase font-bold m-b-0">Privacy Policy</h3>
        </div>
        <div class="panel-body">
            ...
            <div id='ppBody'>
                ...
                <div class='innerText'>Yes. Cookies are small files that a site or its service provider transfers to
                    ...
                    For instance, we use cookies to help us remember and process the items in your shopping cart. They
                ...
                <div class='innerText'>If you turn cookies off, Some of the features that make your site experience more
                    efficient may not function properly.It won't affect the user's experience that make your site
                ...
                <div class='innerText'>We have not enabled Google AdSense on our site but we may do so in the future.
                </div>
                ...
                <div class='innerText'>Once this privacy policy is created, we will add a link to it on our home page or
                    as a minimum, on the first significant page after entering our website.<br></div>
                ...
                <div class='innerText'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <strong>&bull;</strong> By chatting with us or by
            ...
            <div class='innerText'>https://ymag.rainbowriders.dk</div>
            <div class='innerText'>Ved Ovnhallen 3</div>
            Valby, 2500
            <div class='innerText'>Denmark</div>
            <div class='innerText'>info@rainbowriders.dk</div>
            <div class='innerText'><br>Last Edited on 2018-01-18</div>
        </div>
    </div>
</div>
<!-- end card-box-->
